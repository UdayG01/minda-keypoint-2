"""
In this file, we use finger validation ONLY for the second push.
The first push is catered by the connector's closing speed and proximity logic.
"""
...
OUTPUT_VIDEO_PATH = "analysis_outputs/analysis_visual_finger2.mp4"
OUTPUT_IMAGE_PATH = "analysis_outputs/analysis_summary_finger2.png"
...
while cap.isOpened():
    if not paused:
        ...
        for i, r_state in enumerate(roi_states):
            ...
            # Debug ignored finger
            elif finger_trigger and r_state["pushes_detected"] == 0:
                 # print(f"ROI {i}: Finger 1st Push IGNORED by Logic.")
                 pass 
